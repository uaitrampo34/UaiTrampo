  ...
  <div className="min-h-screen bg-background-dark flex flex-col items-center justify-center p-8 overflow-hidden relative">
    ...
    <div className="z-10 flex flex-col items-center gap-8">
      ...
      >
        ...
        <div className="w-28 h-28 bg-primary rounded-[40px] flex items-center justify-center shadow-2xl shadow-primary/40 relative z-10 border-4 border-white/20">
          <ArrowRight className="text-background-dark -rotate-12" size={56} strokeWidth={3} />
          <div className="absolute -top-3 -right-3 bg-background-dark p-2 rounded-full border-2 border-primary shadow-lg">
  ...
  <header className="p-6 flex justify-between items-center sticky top-0 z-50 bg-background-dark/80 backdrop-blur-xl border-b border-white/5">
    <div className="flex items-center gap-3 group">
      <div className="w-12 h-12 bg-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 group-hover:rotate-12 transition-transform">
        <ArrowRight className="text-background-dark" size={24} strokeWidth={3} />
      </div>
      <div>
